...
public class BrsImgActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_brs_img);
    ...
    protected void onStart() {
        ...
        showPhotoView = LayoutInflater.from(BrsImgActivity.this).inflate(R.layout.activity_show_photo, null);
